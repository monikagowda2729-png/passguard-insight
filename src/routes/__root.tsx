...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Private client-side password strength analysis for cybersecurity hygiene.",
      },
      { name: "author", content: "PassGuard" },
      { property: "og:title", content: "PassGuard Password Strength Analyzer" },
      {
        property: "og:description",
        content: "Analyze password strength instantly in your browser without uploading passwords.",
      },
